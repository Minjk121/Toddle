...
#TODO: make bucket name from input

# get file path as an input for parameters
def user_input(date):
    file_path = input("type file path: ") # C:\Users\Minjk\Downloads\lincoln.mp4 
...
def create_note(file_path, file_name, text, date):
    # TODO: update the function (add keyword extraction feature)
